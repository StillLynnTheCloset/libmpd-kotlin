...
publishing {
    ...
    repositories {
        maven {
            ...
            credentials {
                username = project.findProperty("gpr.user") as String? ?: System.getenv("GH_USERNAME").takeUnless { it.isBlank() }!!
                password = project.findProperty("gpr.key") as String? ?: System.getenv("GH_TOKEN").takeUnless { it.isBlank() }!!
            }
        }
    }
}
