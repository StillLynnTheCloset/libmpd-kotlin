...
public enum class MpdRandomState constructor(private val stateKey: String) : MpdObject {
    OFF("0"),
    ON("1"),
    ;
    ...
    internal companion object {
        internal fun fromStateKey(stateKey: String): MpdRandomState = values().first { it.stateKey == stateKey }
    }
}
